#ifndef REMOTE_MANIPULATION_MARKERS_POINT_CLOUD_MANIPULATION_H
#define REMOTE_MANIPULATION_MARKERS_POINT_CLOUD_MANIPULATION_H
...
public:
     ...
     * @param cloud_out object to return the converted point cloud
     */
    static void toSensorMsgs(const pcl::PointCloud<pcl::PointXYZ>::Ptr &cloud_in,
        sensor_msgs::PointCloud2 &cloud_out);
};

#endif // REMOTE_MANIPULATION_MARKERS_POINT_CLOUD_MANIPULATION_H